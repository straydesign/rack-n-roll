        ...
        {events.length > 0 ? (
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {events.map((event, i) => (
              <div
                key={i}
                className="border border-cream/15 rounded-xl p-6 hover:border-amber/50 transition-colors"
              >
                <span className="text-amber text-sm font-medium uppercase tracking-wide">
                  {event.date}
                </span>
